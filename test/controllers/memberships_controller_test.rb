...
class MembershipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create membership" do
    assert_difference('Membership.count') do
      post memberships_url, params: { membership: { isRenewable: @membership.isRenewable, store_id: @membership.store_id } }
    end
  ...
  test "should update membership" do
    patch membership_url(@membership), params: { membership: { isRenewable: @membership.isRenewable, store_id: @membership.store_id } }
